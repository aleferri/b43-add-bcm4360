...
static void b43_phy_ac_mode_init_4352(struct b43_wldev *dev)
{
	b43_phy_write(dev, 0x0410, 0x0077);  /* @0x0005331c */
	b43_phy_write(dev, 0x1728, 0x0080);  /* @0x000534c0 */
	b43_phy_write(dev, 0x1720, 0x0180);  /* @0x000534e8 */
	b43_phy_write(dev, 0x1721, 0x5000);  /* @0x00053538 */
}

/* bphy_init: chip-agnostic (path post-radar_detect_init) */
static void b43_phy_ac_bphy_init_4352(struct b43_wldev *dev)
{
