/* ================================================================
 * extract_radio2069_init.py — output automatico
 * Sorgente: wlDSL-3580_EU.o_save (MIPS BE, BCM4360 3x3)
 * Funzione: wlc_phy_radio2069_pwron_seq
 * Op: generic=20 BCM4352=20 BCM4360=20
 *
 * RMW non estraibili staticamente (inserite manualmente):
...
static void b43_radio_2069_init(struct b43_wldev *dev)
{
	...
	/* RMW 1+2: dalla sequenza di prologue wlc_phy_radio2069_pwron_seq.
	 * Il blob salva PHY 0x728, lo azzera parzialmente e setta 0x720 | 0x180.
	 * Non serve leggere il valore: usiamo mask/set diretti. */
	...
	b43_radio_set(dev, 0x096b, 0x0800);  /* @0x00045330 */
	b43_radio_set(dev, 0x096b, 0x4000);  /* @0x00045770 */
	b43_radio_set(dev, 0x096c, 0x0800);  /* @0x00045794 */
	b43_radio_set(dev, 0x096b, 0x8000);  /* @0x000457b8 */
	b43_radio_set(dev, 0x096b, 0x1000);  /* @0x000457dc */
	b43_radio_set(dev, 0x096b, 0x0004);  /* @0x0004540c */
	...
	/* RMW 3: restore di PHY 0x728 con bit 0x180 settato */
...
/* Op nel path generico non presenti in BCM4352:
